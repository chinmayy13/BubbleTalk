  ...
  return (
    <div className="min h-screen grid lg:grid-cols-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className={`input input-bordered w-full pl-10 h-12 focus:outline-none`}
                  placeholder="Chinmay Kumar"
      ...
      <AuthImagePattern
        ...
        subtitle="Connect with friends, share moments, and stay in touch with your precious ones. "
      />
    </div>
  );
};
